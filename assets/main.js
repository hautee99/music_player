  ...
  songs: [
    {
      ...
      path: './assets/linkmusic/CuoiThoi.flac',
      image: './assets/img/anh5.jpg',
    },
    {
      name: 'Độ Tộc 2',
      singer: 'Độ Mixi; Phúc Du; Pháo; Masew',
      path: './assets/linkmusic/DoToc2.flac',
      image: './assets/img/anh6.jpg',
    },
    {
      name: 'Anh Thương Em Nhất Mà',
      singer: 'Lã. x Log x TiBne',
      path : './assets/linkmusic/Anhthuongemnhatma.mp3',
      image: './assets/img/anh1.jpg',
    },
    {
      name: 'Chúng ta của hiện tại',
      singer: 'Sơn Tùng M-TP',
      path: './assets/linkmusic/ChungTaCuaHienTaiLofiVersion.mp3',
      image: './assets/img/anh2.jpg',
    },
    {
      name: 'Something Just Like This',
      singer: 'The Chainsmokers; Coldplay',
      path: './assets/linkmusic/SomethingJustLikeThis.flac',
      image: './assets/img/anh7.jpg',
    },
    {
      name: 'Ghé Qua',
      singer: 'Dick x PC x Tofu',
      path: './assets/linkmusic/GheQua.flac',
      image: './assets/img/anh3.jpg',
    },
    {
      name: 'Sao Em Vô Tình',
      singer: 'JACK & K-ICM ft. LIAM',
      path: './assets/linkmusic/Saoemvotinh.mp3',
      image: './assets/img/anh4.jpg',
    },
    {
      name: 'Walk Thru Fire',
      singer: 'Vicetone; Meron Ryan',
      path: './assets/linkmusic/WalkThruFire.flac',
      image: './assets/img/anh10.jpg',
    },
    {
      name: 'Why Not Me?',
      singer: 'Enrique Iglesias',
      path: './assets/linkmusic/WhyNotMe.flac',
      image: './assets/img/anh9.jpg',
    },
    {
      name: 'We Dont Talk Anymore (Heyder Remix)',
      singer: 'Charlie Puth; Selena Gomez',
      path: './assets/linkmusic/WeDontTalkAnymoreHeyderRemix.mp3',
